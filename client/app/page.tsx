...
export default function Home() {
  return (
    <main className="relative flex flex-col items-center justify-center min-h-screen overflow-hidden bg-black text-white selection:bg-white selection:text-black">
      ...
      {/* Sleek Vercel-style Fading Grid Background */}
      ...
      <div className="relative z-10 flex flex-col items-center justify-center max-w-4xl px-6 text-center">
        ...
        {/* App Heading */}
        <h1 className="text-5xl font-extrabold tracking-tight sm:text-7xl lg:text-8xl bg-clip-text text-transparent bg-gradient-to-b from-white to-zinc-500 mb-6">
          Real-Time <br className="hidden sm:block" /> Study Rooms
        </h1>

        {/* App Subheading */}
        <p className="max-w-2xl mb-10 text-lg sm:text-xl text-zinc-400">
          Boost your productivity. Join virtual rooms, sync Pomodoro timers, and study together with zero distractions.
        </p>
        ...
        <div className="flex justify-center gap-4">
          <Link 
            href="/login" 
            className="flex items-center justify-center px-8 py-3 text-sm font-semibold text-black transition-all bg-white rounded-full hover:bg-zinc-200 hover:scale-105"
          >
            Get Started
          </Link>
        </div>
