...
export default function RegisterPage() {
  ...
  const handleGoogleAuth = () => {
    alert("Google OAuth needs to be configured on the backend first.");
  };
    ...
    <main className="relative flex flex-col items-center justify-center min-h-screen overflow-hidden bg-black text-white selection:bg-white selection:text-black">
      ...
      <div className="relative z-10 w-full max-w-md p-8 mx-4 border border-zinc-800 bg-zinc-950/50 backdrop-blur-xl rounded-2xl shadow-2xl">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-sm text-zinc-400">Sign up to start joining study rooms.</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="flex flex-col gap-4">
          ...
          <button 
            type="submit" 
            className="w-full py-3 mt-2 text-sm font-semibold text-black transition-all bg-white rounded-lg hover:bg-zinc-200 hover:scale-[1.02] active:scale-95"
          >
            Sign Up
          </button>
        </form>
        ...
        <button 
          ...
          type="button"
          className="flex items-center justify-center w-full gap-3 py-3 text-sm font-medium text-white transition-all border rounded-lg border-zinc-800 bg-zinc-900 hover:bg-zinc-800 active:scale-95"
        >
